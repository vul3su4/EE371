...
add wave -noupdate -color Violet -itemcolor Violet -label cout_updw -radix unsigned -radixshowbase 0 /parkinglot_datapath_testbench/dut/count_updw
...
update
WaveRestoreZoom {3035 ps} {6487 ps}
